    ...
    if (course == null) {
      ...
      if (bbCourse != null) {
        ...
        if (fullDetails) {
            ...
            for (CourseMembership membership : members) {
              ...
              if (userId != null) {
                try {
                  ...
                  final String username = AccessController.doPrivileged(new PrivilegedAction<String>() {
                    @Override
                    public String run() {
                      try {
          ...
          final List<CourseMembership> students = session.getMembershipDbLoader().loadByCourseIdAndRole(bbCourseId,
              Role.STUDENT);
