...
public class ItemKey {
  ...
  public boolean equals(/* @Nullable */Object obj) {
    ...
    if (obj instanceof ItemKey) {
      ...
      return institutionUrl.equals(other.institutionUrl) && uuid.equals(other.uuid) && version == other.version
          && courseId.equals(other.courseId) && folderId.equals(other.folderId)
          && ((page == null && other.page == null) || (page != null && other.page != null && page.equals(other.page)));
    }
    return false;
  }
